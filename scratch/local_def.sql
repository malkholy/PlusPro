    ...
    BEGIN
        ...
        BEGIN TRY
            ...
            BEGIN
                ...
                SET EventName = @Ev_Name, JournalDate = @Ev_Date, JournalState = @Ev_State, JournalPrefix = @Ev_Prefix, JournalDescription = @Ev_Desc, JournalCurrency = @Ev_Currency, JournalExchangeRate = @Ev_ExRate, IsSummarized = @Ev_Summarized, EventLastMaintBy = @User, EventLastMaintDate = GETDATE()
                WHERE EventID = @Ev_ID
            END
