...
export default function PlanningItemHistory({ user }) {
  ...
  const columns = [
    ...
    { key: 'FormulaBatch', label: 'Formula Batch', width: 130, align: 'right', render: (row) => Number(row?.FormulaBatch || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 5 }) },
