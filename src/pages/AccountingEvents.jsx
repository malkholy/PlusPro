...
import AccountingEventsDrawer from './AccountingEventsDrawer.jsx';
import DataGrid from '../shared/DataGrid.jsx';

export default function AccountingEvents({ user, def }) {
  ...
  async function loadData() {
    ...
    setError('');
    try {
      const res = await apiCall('Get Full Events List', null, { User: user?.Username }, 'journal');
      if (res.State === 0) {
        setData(res.List0 || []);
      } else {
