...
-- ============================================================================
-- Refresh the Production Planning History Grid query for the table's new
-- MachineID, FormulaID, FormulaBatch columns -- joined to Machine Master /
-- BOM Header for readable labels, same pattern as Planning Item Master.
-- ============================================================================
